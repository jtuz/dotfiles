...
FILE="$HOME/.config/polybar/xmonad/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/xmonad/scripts/rofi/launcher.rasi
