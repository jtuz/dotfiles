...
FILE="$HOME/.config/polybar/i3/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/i3/scripts/rofi/launcher.rasi
